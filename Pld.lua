...
function job_setup()
	...
	blue_magic_maps.Enhance = S{'Cocoon'}
	blue_magic_maps.Healing = S{'Pollen'}
	blue_magic_maps.Enmity = S{'Sheep Song', 'Blank Gaze'}
end
...
function init_gear_sets()
    ...
    sets.precast.FC = {ammo="Sapience orb",
        ear1="Etiolation earring",ear2="Loquacious Earring",ring2="Prolix Ring",
		body="Odyssean chestplate",hands="Leyline gloves",legs="Enif Cosciales"}

    sets.precast.FC['Enhancing Magic'] = set_combine(sets.precast.FC, {waist="Siegel Sash"})
	
	sets.precast.FC['Blue Magic'] = set_combine(sets.precast.FC)
	sets.precast.FC['Blue Magic'].Enhance = set_combine(sets.precast.FC, {main="Vampirism"})
	sets.precast.FC['Blue Magic'].Healing = set_combine(sets.precast.FC, {main="Sequence"})

       
    -- Weaponskill sets
    -- Default set for any weaponskill that isn't any more specifically defined
    sets.precast.WS = {ammo="Ginsen",
        head="Otomi Helm",neck="Fotia gorget",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Gorney Haubert +1",hands="Cizin Mufflers",ring1="Rajas Ring",ring2="Cho'j Band",
        back="Atheling Mantle",waist="Fotia belt",legs="Cizin Breeches",feet="Whirlpool Greaves"}
    ...
    sets.precast.WS['Sanguine Blade'] = {ammo="Ginsen",
        head="Reverence Coronet +1",neck="Sanctity Necklace",ear1="Friomisi Earring",ear2="Hecate's Earring",
        body="Reverence Surcoat +1",hands="Reverence Gauntlets +1",ring1="Shiva Ring",ring2="Archon Ring",
        back="Toro Cape",waist="Eschan stone",legs="Reverence Breeches +1",feet="Reverence Leggings +1"}
    ...
    sets.midcast.Enmity = {ammo="Iron Gobbet",
        head="Loess Barbuta +1",body={ name="Cab. Surcoat +1", augments={'Enhances "Fealty" effect',}},hands={ name="Founder's Gauntlets", augments={'STR+8','Attack+15','"Mag.Atk.Bns."+13','Phys. dmg. taken -3%',}},
		...
		neck="Unmoving Collar", waist="Windbuffet Belt +1", left_ear="Trux Earring", right_ear="Cessance Earring",
		left_ring="Pernicious Ring", right_ring="Apeile Ring", back="Philidor Mantle",}
    ...
    sets.defense.PDT = {head="Loess Barbuta +1",body={ name="Cab. Surcoat +1", augments={'Enhances "Fealty" effect',}},
		hands={ name="Odyssean Gauntlets", augments={'"Dbl.Atk."+2','Mag. Acc.+28','Chance of successful block +7',}},
		legs={ name="Odyssean Cuisses", augments={'Magic dmg. taken -1%','"Occult Acumen"+8','Damage taken-5%','Accuracy+14 Attack+14','Mag. Acc.+5 "Mag.Atk.Bns."+5',}},
		feet={ name="Odyssean Greaves", augments={'Attack+13','Accuracy+5','Chance of successful block +9','Accuracy+15 Attack+15',}},
		neck="Agitator's Collar",waist="Flume Belt",left_ear="Digni. Earring",right_ear="Cessance Earring",
	...
	sets.engaged.Damage = {head="Loess Barbuta +1",
	...
	sets.engaged.DW.Damage = {head="Odyssean helm",body={ name="Cab. Surcoat +1", augments={'Enhances "Fealty" effect',}},
    ...
    sets.engaged.PDT = set_combine(sets.engaged, {body="Reverence Surcoat +1",neck="Loricate torque +1",ring1="Defending Ring"})
    sets.engaged.Acc.PDT = set_combine(sets.engaged.Acc, {body="Reverence Surcoat +1",neck="Loricate torque +1",ring1="Defending Ring"})
