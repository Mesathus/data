...
function user_setup()
	...
	state.WeaponMode = M{'Burtgang', 'Naegling', 'Malignance','Excalibur','Club'}	--Alt F10
...
function init_gear_sets()
    ...
    sets.midcast.Cure = set_combine(sets.Enmity, {
        ...
        Hands="Macabre Gauntlets +1", --11
        Ear1="Chevalier's Earring +2", --12
        Ear2="Mendicant's Earring", --5
		ring1="Murky Ring",
		ring2="Gelatinous Ring +1",
        Body="Souveran cuirass +1", --11/15
        Feet="Odyssean Greaves", --11 --20SIRD
    }) --63SIRD, 10Merits, 43/30CurePot
