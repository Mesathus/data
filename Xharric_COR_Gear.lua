...
function init_gear_sets()
    ...
    sets.precast.RA = {
        ...
        neck="Comm. Charm +2 ",		 --4
		hands="Lanun Gants +3", 	 --11
		ring2="Haverton Ring",		 --6
        back=gear.CamulusSnapBack,	 --10 
	...
	sets.precast.WS['Aeolian Edge'] = {
		...
		body="Lanun Frac +3",
		hands="Carmine Fin. Ga. +1",
		ring1="Acumen Ring",ring2="Dingir Ring",
		back=gear.CamulusLSBack,
		waist="Eschan Stone",
		legs=gear.HercWSLegs,
		feet="Lanun Bottes +3"
    ...
    sets.engaged.MaxHaste = {
		...
		legs="Samnuha Tights",			-- 
		feet=gear.HercTPFeet			--
        } -- 21 (21+15 from /dnc =36)  (25 dw if /nin)
    ...
    sets.engaged.Hybrid = { --50 PDT
        head="Malignance Chapeau",  --6
		neck="Loricate Torque +1", --6
		body="Meghanada Cuirie +2", --8
        hands="Meghanada Gloves +2", --4
		ring1="Defending Ring", --10
		ring2="Patricius Ring", --5
...
function set_lockstyle()
    send_command('wait 2; input /lockstyleset 38')
end