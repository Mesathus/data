...
-- For song buffs (duration and AF3 set bonus)
	...
	--sets.midcast['Adventurer\'s Dirge'] = set_combine(sets.midcast.SongEffect, {range="Marsyas"})
	--sets.midcast['Foe Sirvente'] = set_combine(sets.midcast.SongEffect, {range="Marsyas"})
...
-- Idle sets (default idle set not needed since the other three are defined, but leaving for testing purposes)
	...
	sets.idle = {main="Daybreak",sub="Genmei shield",range="Nibiru Harp",
		...
		back=gear.IntarabusIDLE,waist="Fucho-no-obi",legs="Assiduity pants +1",feet="Fili cothurnes +1"} 
	...
	sets.idle.Melee = {range="Nibiru Harp",
		...
		back=gear.IntarabusIDLE,waist="Flume Belt +1",legs="Brioso cannions +3",feet="Inyanga crackows +2"} 
