...
function user_setup()
    ...
    gear.CapeEnf = {name="Sucellos's Cape", augments={'MND+20','Mag. Acc+20 /Mag. Dmg.+20'}}
...
function init_gear_sets()
    ...
    sets.precast.FC = {ammo="Staunch tathlum +1",
        ...
        body="Vitiation tabard +3",hands="Volte gloves",ring1="Kishar Ring", ring2="Defending ring",               --13, 6, 4, 0
    ...
    sets.precast.WS = {
        ...
        back="",waist="Grunfeld rope",legs="Nyame Flanchard",feet="Lethargy houseaux +2"}

    -- Specific weaponskill sets.  Uses the base set if an appropriate WSMod version isn't found.
    sets.precast.WS['Requiescat'] = set_combine(sets.precast.WS, {
		head="Lethargy chappel +2",neck="Fotia gorget",
		body="Lethargy Sayon +2",hands="Bunzi's gloves",ring1="Metamorph Ring +1",
		back="Aurist's cape +1",waist="Fotia belt",legs="Lethargy fuseau +2",feet="Lethargy houseaux +2"})
	...
	sets.precast.WS['Savage Blade'] = {
        ...
        back="Aurist's cape +1",waist="Kentarch belt +1",legs="Nyame Flanchard",feet="Lethargy houseaux +2"}
    ...
    sets.precast.WS['Sanguine Blade'] = {ammo="Ghastly tathlum +1",
        ...
        back="Aurist's cape +1",waist="Orpheus's sash",legs="Nyame Flanchard",feet="Lethargy houseaux +2"}
		
	sets.precast.WS['Seraph Blade'] = {ammo="Ghastly tathlum +1",
        head="Lethargy chappel +2",neck="Fotia gorget",ear1="Moonshade Earring",ear2="Malignance Earring",
        body="Nyame Mail",hands="Lethargy gantherots +2",ring1="Metamorph Ring +1",ring2="Epaminondas's Ring",
        back="Aurist's cape +1",waist="Orpheus's sash",legs="Nyame Flanchard",feet="Lethargy houseaux +2"}
		
	sets.precast.WS['Burning Blade'] = {ammo="Ghastly tathlum +1",
        head="Lethargy chappel +2",neck="Sibyl scarf",ear1="Moonshade Earring",ear2="Malignance Earring",
        body="Nyame Mail",hands="Lethargy gantherots +2",ring1="Freke Ring",ring2="Epaminondas's Ring",
        back="Aurist's cape +1",waist="Orpheus's sash",legs="Nyame Flanchard",feet="Lethargy houseaux +2"}
    ...
    sets.midcast['Enhancing Magic'] = {sub = "Ammurapi shield", ammo="Staunch tathlum +1",
		head = "Telchine cap", neck = "Incanter's torque", ear1 = "Mimir earring", ear2 = "Lethargy earring +1",
		body = "Vitiation tabard +3", hands = "Atrophy gloves +2", ring1="Kishar ring", ring2="Stikini ring +1",
		back = gear.CapeEnf, waist = "Embla sash", legs = "Telchine Braconi",feet = "Lethargy houseaux +2" }
    ...
    sets.midcast.Refresh = set_combine(sets.midcast['Enhancing Magic'],{
		head="Amalric coif +1",
		body="Atrophy tabard +2",legs = "Lethargy fuseau +2"})
	...
	sets.midcast['Aquaveil'] = {main="Sakpata's sword",sub="Sacro Bulwark",ammo="Staunch tathlum +1",         --0,7,11
    ...
    sets.midcast['Enfeebling Magic'] = {ammo="Regal gem",
        head="Vitiation chapeau +2",neck="Incanter's torque",ear1="Regal Earring",ear2="Malignance Earring",
        body="Atrophy tabard +2",hands="Lethargy gantherots +2",ring1="Metamorph ring +1",ring2="Stikini ring +1",
        back=gear.CapeEnf,waist="Rumination sash",legs="Lethargy fuseau +2",feet="Vitiation boots +2"}
		
	sets.midcast['Enfeebling Magic'].Burst = sets.midcast['Enfeebling Magic']
		
	sets.midcast['Enfeebling Magic'].Resistant = {range="Ullr",
        head="Atrophy chapeau +2",neck="Incanter's torque",ear1="Regal Earring",ear2="Malignance Earring",
        body="Atrophy tabard +2",hands="Lethargy gantherots +2",ring1="Stikini ring +1",ring2="Stikini ring +1",
        back=gear.CapeEnf,waist="Rumination sash",legs="Lethargy fuseau +2",feet="Lethargy Houseaux +2"}
	...
	sets.midcast['Elemental Magic'].Resistant = {main="Bunzi's rod",sub="Ammurapi Shield",ammo="Ghastly tathlum +1",
        ...
        back="Aurist's cape +1",waist="Orpheus's sash",legs="Amalric slops +1",feet="Lethargy Houseaux +2"}
	...
	sets.midcast['Elemental Magic'].Burst = {main="Bunzi's rod",sub="Ammurapi Shield",ammo="Ghastly tathlum +1",
        ...
        back="Aurist's cape +1",waist="Orpheus's sash",legs="Lethargy fuseau +2",feet="Lethargy Houseaux +2"}
    ...
    sets.idle = {main="Daybreak",sub="Sacro Bulwark",ammo="Homiliary",
        head="Vitiation chapeau +2",neck="Loricate torque +1",ear1="Infused Earring",ear2="Etiolation Earring",
    ...
    sets.idle.Weak = {main="Bolelabunga",sub="Genbu's Shield",ammo="Impatiens",
        head="Vitiation Chapeau +2",neck="Wiglen Gorget",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Atrophy Tabard +2",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Paguroidea Ring",
	...
	sets.idle.Refresh = {main="Daybreak",sub="Sacro Bulwark",ammo="Homiliary",
        head="Vitiation chapeau +2",neck="Loricate torque +1",ear1="Etiolation Earring",ear2="Odnowa Earring +1",
        body="Lethargy Sayon +2",hands="Volte Gloves",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
    ...
    sets.idle.DT = {main="Daybreak",sub="Sacro Bulwark",ammo="Staunch tathlum +1",
        head="Vitiation chapeau +2",neck="Loricate torque +1",ear1="Infused Earring",ear2="Loquacious Earring",
        body="Lethargy Sayon +2",hands="Malignance Gloves",ring1="Sheltered Ring",ring2="Defending Ring",
	...
	sets.engaged.Enspell1 = {ammo="Hasty Pinion +1",
...
function job_post_precast(spell, action, spellMap, eventArgs)
    ...
    if spell.type == 'WeaponSkill' then	
		if player.tp > 1750  and player.equipment.sub == "Machaera +2" then
