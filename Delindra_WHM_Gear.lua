...
function init_gear_sets()
    ...
    sets.precast.FC = {main=gear.FastcastStaff,ammo="Incantor Stone",
        ...
        body="Vanir Cotehardie",hands="Gendewitha Gages",ring1="Prolix Ring",ring2="Lebeche Ring",
    ...
    sets.precast.FC.Cure = set_combine(sets.precast.FC['Healing Magic'], {main="Queller Rod",sub="Genbu's Shield",ammo="Impatiens",
										head="Vanya Hood",earring1="Nourishing Earring +1",hands="Vanya cuffs",back="Pahtli cape",
										feet="Vanya boots"})
    ...
    sets.midcast.CureSolace = {main="Queller Rod",sub="Genbu's Shield",ammo="Incantor Stone",
        head="Vanya hood",neck="Nodens gorget",ear1="Nourishing Earring +1",ear2="Glorious Earring",
        body="Ebers Bliaud +1",hands="Vanya cuffs",ring1="Sirona's Ring",ring2="Lebeche Ring",
        back="Solemnity Cape",waist="Austerity Belt",legs="Ebers Pantaloons +1",feet="Vanya boots"}

    sets.midcast.Cure = {main="Queller Rod",sub="Genbu's Shield",ammo="Incantor Stone",
        head="Vanya hood",neck="Nodens gorget",ear1="Nourishing Earring +1",ear2="Glorious Earring",
        body="Ebers Bliaud +1",hands="Vanya cuffs",ring1="Sirona's Ring",ring2="Lebeche Ring",
        back="Solemnity Cape",waist="Austerity Belt",legs="Ebers Pantaloons +1",feet="Vanya boots"}

    sets.midcast.Curaga = {main="Queller Rod",sub="Genbu's Shield",ammo="Incantor Stone",
        head="Vanya hood",neck="Nodens gorget",ear1="Nourishing Earring +1",ear2="Glorious Earring",
        body="Ebers Bliaud +1",hands="Vanya cuffs",ring1="Sirona's Ring",ring2="Lebeche Ring",
        back="Solemnity Cape",waist="Austerity Belt",legs="Ebers Pantaloons +1",feet="Vanya boots"}
    ...
    sets.midcast.Cursna = {main="Queller Rod",sub="Genbu's Shield",
        ...
        body="Ebers Bliaud +1",hands="Hieros Mittens",ring1="Ephedra Ring",ring2="Sirona's Ring",
    ...
    sets.idle = {main="Bolelabunga", sub="Genbu's Shield",ammo="Homiliary Stone",
        head="Nahtirah Hat",neck="Wiglen Gorget",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Ebers Bliaut +1",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Defending Ring",
