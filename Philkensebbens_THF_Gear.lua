...
function user_setup()
    state.OffenseMode:options('Normal', 'Acc', 'Mod', 'Mod2')
...
function init_gear_sets()
    ...
    sets.TreasureHunter = {hands="Assassin's Armlets +2", waist="Chaac Belt", feet="Raider's Poulaines +2"}
    ...
    sets.precast.WS = {ammo="Thew Bomblet",
        ...
        body="Plunderer's Vest +1",hands="Taeon Gloves",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Kayapa Cape",waist="ElementalBelt",legs="Plun. Culottes +1",feet="Plun. Poulaines +1"}
    ...
    sets.precast.WS['Evisceration'] = set_combine(sets.precast.WS, {ammo="Qirmiz Tathlum",
        head="Uk'uxkaj Cap",neck="Rancor Collar",ear1="Brutal Earring",ear2="Moonshade Earring",legs="Pill. Culottes +1"})
    ...
    sets.precast.WS["Rudra's Storm"] = set_combine(sets.precast.WS, {head="Uk'uxkaj Cap",ear1="Brutal Earring",ear2="Moonshade Earring"})
    ...
    sets.precast.WS['Mandalic Stab'] = set_combine(sets.precast.WS, {head="Uk'uxkaj Cap",ear1="Brutal Earring",ear2="Moonshade Earring"})
    ...
    sets.precast.WS['Last Stand'] = {head="Umbani Cap",neck="Gaudryi necklace",ear1="Clearview Earring",ear2="Volley Earring",
        body="Mekosu. Harness",hands="Qaaxo mitaines",ring1="Rajas Ring",ring2="Paqichikaji Ring",
        back="Kayapa cape",waist="Chaac Belt",legs="Feast hose",feet="Taeon boots"}
    ...
    sets.midcast.Utsusemi = {
        ...
        body="Pillager's Vest +1",hands="Pillager's Armlets +1",ring2="Paqichikaji Ring",
        back="Canny Cape",legs="Kaabnax Trousers",feet="Taeon boots"}

    -- Ranged gear
    sets.midcast.RA = {
        head="Umbani Cap",neck="Gaudryi necklace",ear1="Clearview Earring",ear2="Volley Earring",
        body="Mekosu. Harness",hands="Qaaxo mitaines",ring1="Beeline Ring",ring2="Paqichikaji Ring",
        back="Kayapa cape",waist="Aquiline Belt",legs="Feast hose",feet="Taeon boots"}
    ...
    sets.idle = {ammo="Thew Bomblet",
        ...
        back="Shadow Mantle",waist="Flume Belt",legs="Pillager's Culottes +1",feet="Trotter boots"}

    sets.idle.Town = {main="Mandau", sub="Jugo kukri +1",ammo="Thew Bomblet",
        ...
        back="Shadow Mantle",waist="Patentia Sash",legs="Pillager's Culottes +1",feet="Pillager's poulaines"}
    ...
    sets.defense.PDT = {ammo="Iron Gobbet",
        ...
        back="Iximulew Cape",waist="Olseni Belt",legs="Taeon tights",feet="Qaaxo leggings"}
    ...
    sets.engaged = {ammo="Thew Bomblet",
        ...
        back="Canny cape",waist="Windbuffet Belt +1",legs="Taeon tights",feet="Taeon boots"}
    sets.engaged.Acc = {ammo="Honed Tathlum",
        head="Whirlpool Mask",neck="Ej Necklace",ear1="Steelflash Earring",ear2="Bladeborn Earring",
        body="Pillager's Vest +1",hands="Taeon gloves",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Canny cape",waist="Olseni belt",legs="Taeon tights",feet="Taeon boots"}
        
    -- Mod set for trivial mobs (Skadi+1)
    sets.engaged.Mod = {ammo="Thew Bomblet",
        head="Taeon chapeau",neck="Asperity Necklace",ear1="Brutal Earring",ear2="Suppanomimi",
        body="Skadi's Cuirie +1",hands="Taeon gloves",ring1="Rajas Ring",ring2="Epona's Ring",
    ...
    sets.engaged.Acc.PDT = {ammo="Honed Tathlum",
        ...
        body="Emet Harness",hands="Pillager's Armlets +1",ring1="Defending Ring",ring2="Patricius Ring",
